import type { TEST_ERROR_TYPES_ENUM } from "./test-error-types.enum";

export { TEST_ERROR_TYPES_ENUM } from "./test-error-types.enum";
...
export type APP_ERROR_CODES_TYPE = TEST_ERROR_TYPES_ENUM;
