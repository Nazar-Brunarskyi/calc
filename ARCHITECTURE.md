...
- **Calc** — `lib/calc/calc.util.ts` exports **`calc`** (`ICalcProps`: **`value`**, **`formulas`**) to fold a list of step strings over a starting number. See [lib/calc/README.md](./lib/calc/README.md).
