...
Use the same idea for repositories: `export const userRepository = { … }`, `export const sessionRepository = { … }`, and import `{ userRepository }` / `{ sessionRepository }` as needed.
